...
namespace griffon
{
  ...
  /*
   * Note that this function is not called in performance-critical routines.
   * It is only used in setting up more optimized data containers.
   */
  std::map<std::string, double>
  CombustionKernels::get_element_mw_map ()
  {
