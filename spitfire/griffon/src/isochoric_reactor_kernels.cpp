...
namespace griffon
{
  ...
  void
  CombustionKernels::chem_rhs_isochoric (const double &rho, const double &cv, const double *e, const double *w,
  ...
  void
  CombustionKernels::heat_rhs_isochoric (const double &temperature, const double &rho, const double &cv,
  ...
  void
  CombustionKernels::mass_rhs_isochoric (const double *y, const double *energies, const double *inflowEnergies,
                                                   ...
                                                   double *out_rhs, double *out_jac) const
  {
    ...
    out_jac[firstRow + 1] =
        -invCv
            * (invRho
                * (griffon::blas::inner_product (nSpec, &wsens[nSpec + 1], e)
                    + griffon::blas::inner_product (nSpec, w, cvi)) + out_rhs[1] * cvsensT);
    for (int i = 0; i < nSpec - 1; ++i)
    {
  ...
  void
  CombustionKernels::reactor_rhs_isochoric (const double *state, const double &inflowDensity,
  ...
  void
  CombustionKernels::reactor_jac_isochoric (const double *state, const double &inflowDensity,
                                            const double &inflowTemperature, const double *inflowY, const double &tau,
                                            const double &fluidTemperature, const double &surfTemperature,
                                            const double &hConv, const double &epsRad,
                                            const double &surfaceAreaOverVolume, const int heatTransferOption,
