...
namespace griffon
{
  ...
  void
  CombustionKernels::mechanism_add_element (const std::string& element_name)
  {
  ...
  void
  CombustionKernels::mechanism_add_species (const std::string& species_name,
  ...
  void
  CombustionKernels::mechanism_set_ref_pressure (const double& p_ref)
  {
    mechanismData.phaseData.referencePressure = p_ref;
  }

  void
  CombustionKernels::mechanism_set_ref_temperature (const double& T_ref)
  {
    mechanismData.phaseData.referenceTemperature = T_ref;
  }

  void
  CombustionKernels::mechanism_resize_heat_capacity_data ()
  {
  ...
  void
  CombustionKernels::mechanism_add_const_cp (const std::string& spec_name, const double& Tmin, const double& Tmax,
  ...
  void
  CombustionKernels::mechanism_add_nasa7_cp (const std::string& spec_name, const double& Tmin, const double& Tmid,
  ...
  void
  CombustionKernels::mechanism_add_reaction_simple (const std::map<std::string, int>& reactants_stoich,
  ...
  void
  CombustionKernels::mechanism_add_reaction_three_body (const std::map<std::string, int>& reactants_stoich,
                                                        const std::map<std::string, int>& products_stoich,
                                                        const bool reversible, const double& fwd_pre_exp_value,
                                                        const double& fwd_temp_exponent, const double& fwd_act_energy,
  ...
  void
  CombustionKernels::mechanism_add_reaction_Lindemann (const std::map<std::string, int>& reactants_stoich,
                                                       const std::map<std::string, int>& products_stoich,
                                                       const bool reversible, const double fwd_pre_exp_value,
                                                       const double fwd_temp_exponent, const double fwd_act_energy,
                                                       const std::map<std::string, double>& three_body_efficiencies,
  ...
  void
  CombustionKernels::mechanism_add_reaction_Troe (const std::map<std::string, int>& reactants_stoich,
                                                  const std::map<std::string, int>& products_stoich,
                                                  const bool reversible, const double fwd_pre_exp_value,
                                                  const double fwd_temp_exponent, const double fwd_act_energy,
                                                  const std::map<std::string, double>& three_body_efficiencies,
  ...
  void
  CombustionKernels::mechanism_add_reaction_simple_with_special_orders (
  ...
  void
  CombustionKernels::mechanism_add_reaction_three_body_with_special_orders (
      const std::map<std::string, int>& reactants_stoich, const std::map<std::string, int>& products_stoich,
      const bool reversible, const double& fwd_pre_exp_value, const double& fwd_temp_exponent,
  ...
  void
  CombustionKernels::mechanism_add_reaction_Lindemann_with_special_orders (
      const std::map<std::string, int>& reactants_stoich, const std::map<std::string, int>& products_stoich,
      const bool reversible, const double fwd_pre_exp_value, const double fwd_temp_exponent,
      const double fwd_act_energy, const std::map<std::string, double>& three_body_efficiencies,
  ...
  void
  CombustionKernels::mechanism_add_reaction_Troe_with_special_orders (
      const std::map<std::string, int>& reactants_stoich, const std::map<std::string, int>& products_stoich,
      const bool reversible, const double fwd_pre_exp_value, const double fwd_temp_exponent,
      const double fwd_act_energy, const std::map<std::string, double>& three_body_efficiencies,
      const double& default_efficiency, const double flf_pre_exp_value, const double flf_temp_exponent,
  ...
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_fwd_pre_exponential (const double& v)
    {
      kFwdCoefs[0] = v;
    }
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_fwd_temp_exponent (const double& v)
    {
      kFwdCoefs[1] = v;
    }
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_fwd_activation_energy (const double& v)
    {
      kFwdCoefs[2] = v;
    }
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_reactants (
  ...
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_products (
  ...
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_reactants_or_products (
  ...
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_three_body_efficiencies (
  ...
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_special_orders (
  ...
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_falloff_pre_exponential (const double& v)
    {
      kPressureCoefs[0] = v;
    }
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_falloff_temp_exponent (const double& v)
    {
      kPressureCoefs[1] = v;
    }
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_falloff_activation_energy (const double& v)
    {
      kPressureCoefs[2] = v;
    }
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::set_troe_parameters (const std::vector<double>& troe_params)
    {
  ...
  template<int NSR>
    void
    CombustionKernels::ReactionData<NSR>::ReactionRateData::finalize (const PhaseData& pd)
    {
      {
        sumStoich = 0;
