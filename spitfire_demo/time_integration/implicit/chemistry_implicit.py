...
solve_info_lapack = governor.integrate(right_hand_side=problem.rhs,
...
solve_info_diagonal = governor.integrate(right_hand_side=problem.rhs,
                                         initial_condition=c0,
                                         controller=10. * time_step_size,
                                         method=ESDIRK64(SimpleNewtonSolver()),
...
solve_info_diaggmres = governor.integrate(right_hand_side=problem.rhs,
                                          initial_condition=c0,
                                          controller=10. * time_step_size,
                                          method=ESDIRK64(SimpleNewtonSolver()),
