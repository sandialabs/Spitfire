...
mech_marker_dict = [('usc', 'ro'), ('luo', 'bs'), ('williams', 'gD')]
...
for mech, marker in mech_marker_dict:
    b = ChemicalMechanismSpec(cantera_xml='mechanisms/ethylene-' + mech + '.xml', group_name='ethylene-' + mech)
    ...
    for idx, tau in enumerate(tau_vec):
        ...
        r.integrate_to_steady_direct_griffon(steady_tolerance=1.e-8, transient_tolerance=1.e-10)
