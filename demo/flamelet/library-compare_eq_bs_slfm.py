...
m = ChemicalMechanismSpec(cantera_xml='mechanisms/heptane-liu-hewson-chen-pitsch-highT.xml',
                          group_name='gas')
...
l = build_adiabatic_eq_library(flamelet_specs, quantities, verbose=True)
h_eq = l['enthalpy']
T_eq = l['temperature']
YOH_eq = l['mass fraction OH']
YC2H2_eq = l['mass fraction C2H2']

l = build_adiabatic_bs_library(flamelet_specs, quantities, verbose=True)
h_bs = l['enthalpy']
T_bs = l['temperature']
