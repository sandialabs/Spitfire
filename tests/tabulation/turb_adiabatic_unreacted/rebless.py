...
def run():
    ...
    from spitfire.chemistry.tabulation import build_unreacted_library, apply_mixing_model, PDFSpec
...
if __name__ == '__main__':
    gold_pkl = abspath(join('tests', 'tabulation', 'turb_adiabatic_unreacted', 'gold.pkl'))
    output_library = run()
